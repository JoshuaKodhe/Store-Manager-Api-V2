...
class BaseTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.proper_product = json.dumps({"name": "chair",
                                          "category": "furniture",
                                          "price": 200,
                                          "quantity": 15,
                                          "description": "great quality"})
        self.proper_product_2 = json.dumps({"name": "Table",
                                            "category": "furniture",
                                            "price": 200,
                                            "quantity": 15,
                                            "description": "great quality"})
    ...
    def make_sale_2(self):
        response = self.client.post(base_url+"/sales",
                                    ...
                                    headers=dict(
                                        Authorization="Bearer "+self.login_attendant_2()),
                                    content_type='application/json')
        return response
